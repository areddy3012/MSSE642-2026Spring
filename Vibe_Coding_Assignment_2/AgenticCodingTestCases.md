...
- Using an Agentic AI tools, e.g. ChatGPT, Git Hub Copilot, Claude Code, Replit, etc., write some code or create an app using "no code" that illustrates the Test Case for the Week.
...
![Bug Hunter Screen Shot created in Replit](https://github.com/programmingkitchen/regis-msse/blob/main/!MSSE640-2026Spring2/assignments/images/bughunter.png)
...
## Additional Links
- [Code](https://github.com/programmingkitchen/regis-msse)
- [Issues](https://github.com/programmingkitchen/regis-msse/issues)
- [Pull requests](https://github.com/programmingkitchen/regis-msse/pulls)
- [Actions](https://github.com/programmingkitchen/regis-msse/actions)
- [Projects](https://github.com/programmingkitchen/regis-msse/projects)
- [Security and quality](https://github.com/programmingkitchen/regis-msse/security)
- [regis-msse](https://github.com/programmingkitchen/regis-msse/tree/main)
- [!MSSE640-2026Spring2](https://github.com/programmingkitchen/regis-msse/tree/main/!MSSE640-2026Spring2)
- [assignments](https://github.com/programmingkitchen/regis-msse/tree/main/!MSSE640-2026Spring2/assignments)
